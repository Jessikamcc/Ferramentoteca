...
public class TelaCadastroFerra extends javax.swing.JFrame {
    ...
    private boolean validarCampos() {
        ...
        // Verifica localização (se não é a opção padrão)
        if (jComboBoxLocaliza.getSelectedIndex() == 0) { // Assumindo que a primeira opção é "Selecione..."
            JOptionPane.showMessageDialog(this, "Selecione uma Localização!", "Aviso", JOptionPane.WARNING_MESSAGE);
            return false;
        }

        // Verifica motivo de desativação (se status for "Desativar")
    ...
    private void limparCampos() {
        ...
        jComboBoxLocaliza.setSelectedIndex(0);
